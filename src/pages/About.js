...
export default function About() {
  return (
    <section className='text-white px-10 xl:text-xl lg:px-6 md:px-4 sm:px-0 content grid grid-cols-2 gap-10 xl:grid-cols-1 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1'>
      <div className='.about-big col-span-2 xl:col-span-1 lg:col-span-1 md:col-span-1 sm:col-span-1 text-6xl p-10 text-center'>
